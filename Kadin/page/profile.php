      ...
      if ($pwdCheck == false) {
        ...
        exit();
          ...
          echo "<script>alert('Your new password is not same');</script>";
            ...
            $sql = mysqli_query($link,"UPDATE tb_user SET nama = '$nama', no_hp = '$no_hp', email = '$email', password = '$new_pwd' WHERE id_user = '$id_user' " );
        ...
        <div class="card bg-secondary shadow border-0">
          <div class="card-body px-lg-5 py-lg-5">
            <form role="form" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                        <input type="text" name="no_hp" class="form-control" id="fname" placeholder="No Handphone" value="<?php  echo $result['no_hp']?>">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-sm-12">
