    ...
    <div class="col-lg-3">
        <div class="card">
          <div class="card-header">
            JUMLAH PENGAJUAN YANG BELUM SELESAI BULAN INI
          </div>
          <div class="card-body">
            <?php
            $tahun = date('Y');
            $bulan = date('m');
            $sql_jumlah = "SELECT COUNT(no_ticket) AS jumlah FROM `tb_request` WHERE status = 2 and month(tgl_req) = $bulan AND year(tgl_req) = $tahun";
